...
class LanguageController {
  constructor(select, documentRoot, settings) {
    ...
    this.pageTranslations = {
      nl: {
        common: { backPortfolio:'Terug naar portfolio', backWork:'Terug naar geselecteerd werk', viewWork:'Bekijk geselecteerd werk ↗', viewSource:'Bekijk broncode op GitHub' },
      ...
      zh: {
        common: { backPortfolio:'返回作品集', backWork:'返回精选作品', viewWork:'查看精选作品 ↗', viewSource:'在 GitHub 查看源代码' },
      ...
      es: {
        common: { backPortfolio:'Volver al portafolio', backWork:'Volver al trabajo seleccionado', viewWork:'Ver trabajo seleccionado ↗', viewSource:'Ver codigo fuente en GitHub' },
